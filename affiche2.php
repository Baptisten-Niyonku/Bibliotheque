...
include_once "./autres/menu2.php";

$bd = new PDO('mysql:host=localhost;dbname=bibliotheque','root','');

if ($bd==null){echo "Echec de connection";}

echo '<form action="./search.php" method="POST" style="margin-top:5px;"><a style="font-size: 36px; background-color: orange; text-decoration: none;
padding: 8px; font-weight: bold; margin-left: 60px;" href="./autres/formulaire.html">Ajouter</a>
<input style="font-size: 35px; padding: 5px; border:1px solid blue;" type="text" name="isearch" placeholder="Rechercher...">
<input style="font-size: 40px; cursor: pointer; border:1px solid blue;" type="submit" name="bsearch" value="search">
</form>';
